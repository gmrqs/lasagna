...
#  Default: ''
c.NotebookApp.notebook_dir = 'usr/local/spark_dev/work'
...
#  Choices: any of ['sha3_512', 'sha512', 'blake2b', 'sha1', 'sha3_256', 'sha256', 'md5', 'sha3_384', 'sha384', 'sha3_224', 'sha224', 'blake2s']
#  Default: 'sha256'
